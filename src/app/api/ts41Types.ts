...
export type TS41Hooks<Definitions extends EndpointDefinitions> = {
  [K in string & keyof Definitions as TS41HookName<
    K,
    Definitions[K]
  >]: Definitions[K] extends QueryDefinition<any, any, any, any>
...
> = `use${Capitalize<K>}${Definition extends QueryDefinition<any, any, any, any>
  ? 'Query'
  : 'Mutation'}`;
